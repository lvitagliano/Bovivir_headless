...
const DescriptionSelection = props => {
  ...
  console.log(useSubscriptionDate())
    ...
    return (
      <>
        <DescriptionSelectionCard>
            ...
            <img src=""/>
            <LabelForm fontSize="10px" style={{textAlign:'center'}}>Diferentes cepas y estilos de vinos cuidadosamente elegidos. Incluye fichas coleccionables con maridajes.</LabelForm>
            <ContainerOneColumn>
              <ContainerOneRow>
